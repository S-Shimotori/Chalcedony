            ...
            context("when you get one data per day") {
                beforeEach {
                    let stayLaboDataList = [
                        //Sunday
                        CCDStayLaboData(
                            laboinDate:   self.makeNSDate(2015, month: CCDMonth.June     , day: 21, hour:  0, minute:  0, second:  0),
                            laboridaDate: self.makeNSDate(2015, month: CCDMonth.June     , day: 21, hour:  0, minute:  0, second: 10)),
                        //Monday
                        CCDStayLaboData(
                            laboinDate:   self.makeNSDate(2015, month: CCDMonth.June     , day: 22, hour:  0, minute:  0, second:  0),
                            laboridaDate: self.makeNSDate(2015, month: CCDMonth.June     , day: 22, hour:  0, minute: 10, second:  0)),
                        //Tuesday
                        CCDStayLaboData(
                            laboinDate:   self.makeNSDate(2015, month: CCDMonth.June     , day: 23, hour:  0, minute:  0, second:  0),
                            laboridaDate: self.makeNSDate(2015, month: CCDMonth.June     , day: 23, hour: 10, minute:  0, second:  0)),
                        //Wednesday
                        CCDStayLaboData(
                            laboinDate:   self.makeNSDate(2015, month: CCDMonth.June     , day: 24, hour:  0, minute:  0, second:  0),
                            laboridaDate: self.makeNSDate(2015, month: CCDMonth.June     , day: 24, hour:  0, minute: 10, second: 10)),
                        //Thursday
                        CCDStayLaboData(
                            laboinDate:   self.makeNSDate(2015, month: CCDMonth.June     , day: 25, hour:  0, minute:  0, second:  0),
                            laboridaDate: self.makeNSDate(2015, month: CCDMonth.June     , day: 25, hour: 10, minute:  0, second: 10)),
                        //Friday
                        CCDStayLaboData(
                            laboinDate:   self.makeNSDate(2015, month: CCDMonth.June     , day: 26, hour:  0, minute:  0, second:  0),
                            laboridaDate: self.makeNSDate(2015, month: CCDMonth.June     , day: 26, hour: 10, minute: 10, second:  0)),
                        //Saturday
                        CCDStayLaboData(
                            laboinDate:   self.makeNSDate(2015, month: CCDMonth.June     , day: 27, hour:  0, minute:  0, second:  0),
                            laboridaDate: self.makeNSDate(2015, month: CCDMonth.June     , day: 27, hour: 10, minute: 10, second: 10)),
                    ]
                ...
                it("has processed correctly data") {
                ...
                it("has the correct number of data") {
